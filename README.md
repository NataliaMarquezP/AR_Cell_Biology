...
- Aplicar conceptos de desarrollo en Unity.
- Implementar una interfaz gráfica para la navegación entre estructuras.
- Organizar correctamente los assets y componentes del proyecto.
...
- Cambio entre células y organelos.
- Interfaz adaptada para dispositivos móviles.
- Organización jerárquica de elementos dentro de la escena.
...
- Título principal
- Botón Célula Animal
- Botón Célula Vegetal
- Botón Mitocondria
- Botón Aparato de Golgi
- Botón Retículo Endoplasmático
...
```bash
git clone https://github.com/NataliaMarquezP/AR_Cell_Biology.git
```

2. Abrir el proyecto en Unity.

3. Verificar que estén instalados:

- AR Foundation
- Google ARCore XR Plugin
- XR Plug-in Management

4. Cambiar la plataforma a Android.

5. Compilar utilizando:
...
- Prueba de compilación Android.
- Pruebas de depuración mediante la consola de Unity.
...
- Organización adecuada de assets.
